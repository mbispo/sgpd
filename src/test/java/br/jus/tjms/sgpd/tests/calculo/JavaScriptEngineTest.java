...
public class JavaScriptEngineTest {
	...
	@Test
	public void testaJavaScriptEngine() {
	...
	@Test
	public void deveTestarExpressaoUsandoJavaScriptEngine() {
		...
		try {
			resultado = (Boolean) ScriptEngineFactory.fabricar(TipoScript.JAVA_SCRIPT).executar(expressao, contexto, "contexto");
	...
	public void deveExecutarScriptERetornarObjetoContextoAlterado() {
		...
		try {
			resultado = (Dto) ScriptEngineFactory.fabricar(TipoScript.JAVA_SCRIPT).executar(script, contexto, "contexto");
